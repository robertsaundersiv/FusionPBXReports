...
class AgentQueueTier(Base):
    ...
    id = Column(Integer, primary_key=True)
    agent_uuid = Column(String(36), ForeignKey('agents.agent_uuid'))
    queue_id = Column(String(36), ForeignKey('queues.queue_id'))
    ...
    __table_args__ = (
        UniqueConstraint('agent_uuid', 'queue_id', name='uq_agent_queue'),
    )
